...
#pragma region Component
	...
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Texture_Number_Red")
		, CTextures::Create(m_pDevice, m_pDevice_Context, ETextureType::Wic, TEXT("../Bin/Resources/Textures/Number/Red/%d.png"), 11));
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Texture_Number_Green")
		, CTextures::Create(m_pDevice, m_pDevice_Context, ETextureType::Wic, TEXT("../Bin/Resources/Textures/Number/Green/%d.png"), 10));
	...
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Texture_GreenBall_2")
		, CTextures::Create(m_pDevice, m_pDevice_Context, ETextureType::Wic, TEXT("../Bin/Resources/Effect/GreenBall/1.png")));
	...
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Texture_Red_Dark")
		, CTextures::Create(m_pDevice, m_pDevice_Context, ETextureType::Wic, TEXT("../Bin/Resources/Effect/Red/Red_Dark.png")));
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Texture_Aura")
	...
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Texture_Glow_Blue")
		, CTextures::Create(m_pDevice, m_pDevice_Context, ETextureType::Wic, TEXT("../Bin/Resources/Effect/Glow_Blue.png")));
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Texture_Mola")
		, CTextures::Create(m_pDevice, m_pDevice_Context, ETextureType::Wic, TEXT("../Bin/Resources/Effect/Mola.png")));
...
#pragma region Model
	...
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Mesh_ManaToken"),
		CModel::Create(m_pDevice, m_pDevice_Context, "../Bin/Resources/Mesh/ManaToken/", "ManaToken.fbx", TEXT("../Bin/Shader/Shader_Model.hlsl"), "DefaultTechnique"));
	...
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Mesh_HalfSphere"),
	...
	hr = m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_Mesh_Ring"),
		CModel::Create(m_pDevice, m_pDevice_Context, "../Bin/Resources/Mesh/Ring/", "Ring.fbx", TEXT("../Bin/Shader/Shader_Model.hlsl"), "DefaultTechnique"));
...
#pragma region Instance Buffer
	...
	CEffectDesc_Manager::GetInstance()->Set_Instance(EInstanceValue::Point_Ex_50_1, 1000, 5);
	if (FAILED(m_pGameInstance->Add_Prototype((_uint)ELevel::Stage1, TEXT("Component_VIBuffer_PointInstance_Ex_50_1")
