...
#define GET_CAMERA_RIGHT	CGameInstance::GetInstance()->Get_CamRight_Dir()
#define GET_CAMERA_UP		CGameInstance::GetInstance()->Get_CamUp_Dir()
#define GET_CAMERA_LOOK		CGameInstance::GetInstance()->Get_CamLook_Dir()
#define GET_CAMERA_POSITION	CGameInstance::GetInstance()->Get_CamPosition()
