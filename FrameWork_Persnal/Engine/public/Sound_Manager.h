...
enum ENGINE_DLL CHANNEL_TYPE
{
	...
	, CHANNEL_BOSS, CHANNEL_BOSS_A, CHANNEL_BOSS_H, CHANNEL_BOSS_D, CHANNEL_BOSS_E
	, CHANNEL_TOWER_1, CHANNEL_TOWER_2, CHANNEL_TOWER_3
	, CHANNEL_EFFECT_PLAYER, CHANNEL_EFFECT_PLAYER_E1, CHANNEL_EFFECT_PLAYER_E2, CHANNEL_EFFECT_PLAYER_H
